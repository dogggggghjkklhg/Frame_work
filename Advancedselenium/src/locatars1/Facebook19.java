...
WebElement ele1=driver.findElement(By.xpath("(//div[class='a-section a-spacing-small puis-padding-left-micro puis-padding-right-micro'])"));

Point loc=ele1.getLocation();
System.out.print(ele1.getLocation());
