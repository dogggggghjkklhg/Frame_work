...
//	@FindBy(xpath = "//select[class='react-datepicker__month-select']")       BY USING SELECT CLASS      
//	private WebElement dateofbirth2;
//	Select s = new Select(dateofbirth2);
	@FindBy(xpath = "//div[.='7']")           
...
//	public void dob2()
//	{
//		s.selectByValue("1");           BY USING SELECT CLASS 
//		
//	
//
//}
	...
	public void adress1()
	{
		adress.sendKeys("hellllllllllllllllllllllllooooooooooooooooooooooooo");
